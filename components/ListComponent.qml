    ...
    id:list
         ...
         delegate: Item{
             ...
             MouseArea{
                 anchors.fill: parent
                 onClicked: {
                     //add.replaceDice(model.index,{"sides":dice.contents.type[0].sides},{"sides":dice.contents.type[model.index].sides, "roll":Logic.roll(dice.contents.type[model.index].sides)});
